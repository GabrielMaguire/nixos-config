  ...
  config = lib.mkMerge [
    ...
    # XDG
    {
      ...
      environment.systemPackages = with pkgs; [
        xdg-desktop-portal-gtk # TODO: Do I need this if I also have xdg.portal.extraPortals
        xdg-desktop-portal-hyprland # TODO: ^
      ];
    }
    ...
    # Docker
    {
      ...
      users.users.gabriel.extraGroups = [ "docker" ];
    }
